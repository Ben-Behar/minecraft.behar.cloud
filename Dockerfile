# docker build . -t docks.behar.cloud/minecraft.behar.cloud
FROM alpine:3.3
...
# docker run -itp 25565:25565 -v minecraft.behar.cloud-world:/app/world -v minecraft.behar.cloud-mods:/app/mods -v minecraft.behar.cloud-io:/app/io --name minecraft.behar.cloud docks.behar.cloud/minecraft.behar.cloud
